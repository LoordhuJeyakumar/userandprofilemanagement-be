    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="contact-info">
                <p>Email: <a href="mailto:loordhujeyakumar@gmail.com">loordhujeyakumar@gmail.com</a></p>
                <p>Phone: <a href="tel:+9600693684">+91 96006 93684</a></p>
            </div>
        </div>
        < spent in processing and contextual understanding of the language involved. "Reset Password Request" email template is primarily to be used for transactional purposes and is written in simple HTML and CSS to make sure it can be read and displayed correctly on almost all email clients.
        div class="footer">
            <p>If you have any questions, please don't hesitate to contact us at the information above.</p>
            <p>Thank you,</p>
